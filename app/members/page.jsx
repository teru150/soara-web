...
const MembersPage = () => {
  ...
  const members = [
    ...
    },
    {
      ...
      introduction: "設計とデザインの両方に関心があり、「考えたものを実際に形にする」ことを大切にしています。3D CADを用いた設計や、3Dプリンター・レーザー加工による制作を通して、構造面とデザイン面の両立を学んできました。SOARAでは、機体設計の一部やグラフィック制作を担当し、チームの挑戦を支える存在でありたいと考えています。",
    },
    {
      name: "服部裕斗",
